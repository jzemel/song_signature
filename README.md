...
* scroll around
* hover on a song to highlight all instances of that song
* click to make the highlight stick
* use the dropdown to color by shows since played (default), song age, likes, or just orange.
* search for a song to highlight it
* drop feedback 
